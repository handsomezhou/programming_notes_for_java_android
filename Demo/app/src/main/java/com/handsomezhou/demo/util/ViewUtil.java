...
public class ViewUtil {
	 ...
	 * @param value
	 */
	public static void refreshEt(EditText editText, double value) {
		do{
			if(null==editText){
				break;
			}

			editText.setText(String.format(Constant.FORMAT_FOUR_DECIMAL_PLACES, value));
			//editText.setText(String.format(Constant.FORMAT_THREE_DECIMAL_PLACES, value));
		}while (false);
	 ...
	 * @param value
	 */
	public static void refreshEt(EditText editText, int value) {
		do{
			if(null==editText){
				break;
			}
